...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jithuabi619_db_user:<db_password>@cluster0.tkyuhfu.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
